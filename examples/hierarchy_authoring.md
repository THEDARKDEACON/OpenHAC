...
2. Read **`logical_modules`**, optional **`logical_module_names`**, and **`schematic_hierarchy_handoff`** in `{project}.openhac-manifest.json`: each entry lists the module name and SKiDL **references** that belong to that subtree.
