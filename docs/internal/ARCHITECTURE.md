...
This document captures **cross-cutting software design** that complements numbered items in [PRODUCTION_READINESS_SPEC.md](./PRODUCTION_READINESS_SPEC.md) (Phase-1), [FABRICATION_READINESS_SPEC.md](./FABRICATION_READINESS_SPEC.md) (Phase-2), and [SPICE_SIGN_OFF_SPEC.md](./SPICE_SIGN_OFF_SPEC.md) (**SPS-***).
...
- **`openhac.compiler.spice_nodes`**: ground → node `0`; legal node names (`3V3` → `N_3V3`).
